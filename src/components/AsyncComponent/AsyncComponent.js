...
// ** customize expense **
const AsyncExpenseComponent = Loadable({
  loader: () => import("Routes/expense/expense-form-lists"),
  loading: () => <RctPageLoader />
});

// ** customize revenue **
const AsyncRevenuesListComponent = Loadable({
  loader: () => import("Routes/revenues/revenues-form-lists"),
  loading: () => <RctPageLoader />
});

// ** customize revenue **
const AsyncRevenuesCardComponent = Loadable({
  loader: () => import("Routes/revenues/revenues-form-card"),
  loading: () => <RctPageLoader />
});

// ** customize vendor **
const AsyncVendorComponent = Loadable({
  loader: () => import("Routes/vendor/vendor-form-lists"),
  loading: () => <RctPageLoader />
});
...
export {
  AsyncVendorComponent, // **customize**
  AsyncRevenuesCardComponent,
  AsyncRevenuesListComponent, // **customize**
  AsyncExpenseComponent, // **customize**
