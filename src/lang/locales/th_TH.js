module.exports = {
  ...
  "sidebar.expense.button.delete": "ลบ",
  "sidebar.expense.button.send": "ส่ง",
  "sidebar.expense.button.approve": "อนุมัติ",
  "sidebar.expense.button.disapprove": "ไม่อนุมัติ",
  ...
  "sidebar.expense.dialog.add.description.add": "เพิ่ม",
  "sidebar.expense.dialog.add.billno": "หมายเลขบิล",
  "sidebar.expense.dialog.add.billno.placeholder": "ระบุหมายเลขบิล",
  "sidebar.expense.dialog.add.billno.validate": "หมายเลขบิลนี้ถูกใช้ไปแล้ว",
  "sidebar.expense.dialog.add.billdate": "วันที่บิล",
  "sidebar.expense.dialog.add.total": "ยอดรวม",
  "sidebar.expense.dialog.add.total.placeholder": "ระบุยอดรวม",
  "sidebar.expense.dialog.add.btn.add": "เพิ่ม",

  "sidebar.expense.table.no": "ลำดับ",
  "sidebar.expense.table.discription": "รายละเอียด",
  "sidebar.expense.table.billno": "หมายเลบบิล",
  ...
  "sidebar.expense.dialog.update.description.add": "เพิ่ม",
  "sidebar.expense.dialog.update.billno": "หมายเลขบิล",
  "sidebar.expense.dialog.update.billno.placeholder": "ระบุหมายเลขบิล",
  "sidebar.expense.dialog.update.billno.validate": "หมายเลขบิลนี้ถูกใช้ไปแล้ว",
  "sidebar.expense.dialog.update.billdate": "วันที่บิล",
  "sidebar.expense.dialog.update.total": "ยอดรวม",
  "sidebar.expense.dialog.update.total.placeholder": "ระบุยอดรวม",
  "sidebar.expense.dialog.update.btn.update": "อัพเดท",
  "sidebar.expense.dialog.btn.cancel": "ยกเลิก",
  "sidebar.expense.dialog.btn.yes": "ใช่",

  "sidebar.expense.dialog.delete.title": "ลบ?",
  "sidebar.expense.dialog.delete.message": "คุณแน่ใจหรือไม่ว่าต้องการลบ?",

  "sidebar.expense.dialog.send.title": "ส่ง?",
  "sidebar.expense.dialog.send.message": "คุณแน่ใจหรือไม่ว่าต้องการส่ง?",
  // * expense * //
  "sidebar.management": "การจัดการ",
  // * revenue * //
  ...
  "sidebar.revenues.dialog.caption.producttype": "สินค้าประเภท",
  "sidebar.revenues.dialog.btn.attach": "แนบรูปภาพ",
  "sidebar.revenues.dialog.btn.attached": "แสดงรูปภาพ",
  "sidebar.revenues.dialog.add.title": "เพิ่มรายได้",
  "sidebar.revenues.dialog.add.preview": "ดูตัวอย่างรายได้",
  "sidebar.revenues.dialog.add.update": "อัพเดทรายได้",
  "sidebar.revenues.dialog.filter.date": "เลือกวันที่บิล",
  "sidebar.revenues.dialog.filter.branch": "เลือกสาขา",
  "sidebar.revenues.dialog.petrol": "สินค้าประเภท : น้ำมัน",
  "sidebar.revenues.dialog.petrol.header.price": "ราคา",
  "sidebar.revenues.dialog.petrol.header.quantity": "ปริมาณ",
  "sidebar.revenues.dialog.petrol.header.total": "มูลค่า",
  "sidebar.revenues.dialog.petrol.header.paymenttype": "ประเภทการชำระเงิน",
  "sidebar.revenues.dialog.petrol.row.b20diesal": "B20 DIESAL",
  "sidebar.revenues.dialog.petrol.row.e20gsh": "E20 GSH",
  "sidebar.revenues.dialog.petrol.row.fsdiesal": "FS DIESAL",
  "sidebar.revenues.dialog.petrol.row.fsgsh91": "FS GSH91",
  "sidebar.revenues.dialog.petrol.row.vpdiesal": "VP DIESAL",
  "sidebar.revenues.dialog.petrol.row.vpgsh95": "VP GSH95",
  "sidebar.revenues.dialog.engineoil": "สินค้าประเภท : น้ำมันเครือง",
  "sidebar.revenues.dialog.engineoil.b20diesal": "B20 DIESAL",
  "sidebar.revenues.dialog.engineoil.e20gsh": "E20 GSH",
  "sidebar.revenues.dialog.engineoil.fsdiesal": "FS DIESAL",
  "sidebar.revenues.dialog.engineoil.fsdiesal": "FS DIESAL",
  "sidebar.revenues.dialog.carcare": "สินค้าประเภท : คาร์แคร์",
  "sidebar.revenues.dialog.carcare.sizes": "ไซส์ S",
  "sidebar.revenues.dialog.carcare.sizem": "ไซส์ M",
  "sidebar.revenues.dialog.carcare.sizel": "ไซส์ L",
  "sidebar.revenues.dialog.carcare.washcar": "ล้างรถ",
  "sidebar.revenues.dialog.carcare.wax": "ลงแวกซ์",
  "sidebar.revenues.dialog.conveniencestore": "สินค้าประเภท : ร้านสะดวกซื้อ",
  "sidebar.revenues.dialog.conveniencestore.food": "Food",
  "sidebar.revenues.dialog.conveniencestore.foodnon": "Non-Food",
  "sidebar.revenues.dialog.cafe": "สินค้าประเภท : คาเฟ่",
  "sidebar.revenues.dialog.cafe.revenue": "รายได้ร้านคาเฟ่",
  "sidebar.revenues.dialog.btn.add": "เพิ่ม",
  "sidebar.revenues.dialog.btn.clear": "เคลียร์",
  "sidebar.revenues.dialog.btn.close": "ปิด",
  "sidebar.revenues.dialog.btn.update": "อัพเดท",
  "sidebar.revenues.dialog.btn.delete": "ลบ",
  "sidebar.revenues.dialog.btn.send": "ส่ง",
  "sidebar.revenues.dialog.btn.approve": "อนุมัติ",
  "sidebar.revenues.dialog.btn.disapprove": "ไม่อนุมัติ",

  "sidebar.revenues.dialog.delete.title": "ลบ?",
  "sidebar.revenues.dialog.delete.message": "คุณแน่ใจหรือไม่ว่าต้องการลบ?",
  "sidebar.revenues.dialog.send.title": "ส่ง?",
  "sidebar.revenues.dialog.send.message": "คุณแน่ใจหรือไม่ว่าต้องการส่ง?",
  "sidebar.revenues.dialog.approve.title": "อนุมัติ?",
  "sidebar.revenues.dialog.approve.message":
    "คุณแน่ใจหรือไม่ว่าต้องการอนุมัติ?",
  "sidebar.revenues.dialog.disapprove.title": "ไม่อนุมัติ?",
  "sidebar.revenues.dialog.disapprove.message":
    "คุณแน่ใจหรือไม่ว่าต้องการไม่อนุมัติ?",

  "sidebar.dialog.session.btn.accept": "ยอมรับ",

  "sidebar.revenues": "รายได้",
